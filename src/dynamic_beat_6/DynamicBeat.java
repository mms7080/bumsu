...
public class DynamicBeat extends JFrame{
	...
	//백그라운드 이미지 파일 받아오기
	private Image SelectedImage = new ImageIcon(Main.class.getResource("../images/roze.png")).getImage();
	//로제 아파트 이미지
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/rozetitle.png")).getImage();
