...
public class DynamicBeat extends JFrame{
	...
	private ImageIcon easyButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/leftEntered.png"));
	private ImageIcon easyButtonBasicImage = new ImageIcon(Main.class.getResource("../images/leftBasic.png"));
	// 왼쪽으로이동 버튼이미지
	private ImageIcon hardButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/rightEntered.png"));
	private ImageIcon hardButtonBasicImage = new ImageIcon(Main.class.getResource("../images/rightBasic.png"));
	// 오른쪽으로이동 버튼이미지
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("rozetitle.png","roze.png","roze.png","apt.mp3","apm.mp3"));
		trackList.add(new Track("powertitle.png","power.png","power.png","power.mp3","power.mp3"));
		trackList.add(new Track("aespatitle.png","aespa.png","aespa.png","aespa.mp3","aespa.mp3"));
