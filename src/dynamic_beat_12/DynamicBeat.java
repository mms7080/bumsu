...
public class DynamicBeat extends JFrame{
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("rozetitle.png","roze.png","game_background.jpg","apt.mp3","apt.mp3","A.P.T - Roze,Brono Mars"));
		trackList.add(new Track("powertitle.png","power.png","game_background.jpg","power.mp3","power.mp3","POWER - G.D"));
		trackList.add(new Track("aespatitle.png","aespa.png","game_background.jpg","aespa.mp3","aespa.mp3","Armageddon - aespa"));
		System.out.println("track list : " + trackList.get(0).getTitleName());
		...
		easyButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				Music buttonPressedMusic = new Music("left.mp3",false);
				buttonPressedMusic.start(); //마우스 올라갔을 때 소리
				System.out.println("aaaaaaaaaaaaaaaaaa" + nowSelected);
		...
		backButton.setBounds(20,50,60,60); //  버튼 위치
		...
		backButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				backButton.setCursor(new Cursor(Cursor.HAND_CURSOR)); //마우스가 올라갔을때 손가락 마우스커서 추가
				Music buttonEnterMusic = new Music("buttonEnterMusic.mp3",false);
				buttonEnterMusic.start(); //마우스 올라갔을 때 소리
			} // 마우스 올라갔을때 이미지 변경
			@Override
			public void mouseExited(MouseEvent e) {
				...
				backButton.setCursor(new Cursor(Cursor.DEFAULT_CURSOR)); //마우스가 떨어졌을때 손가락 마우스커서 제거
			} // 마우스가 떨어지면 이미지 변경
			@Override
			public void mousePressed(MouseEvent e) {
				Music buttonPressedMusic = new Music("left.mp3",false);
...
//		메뉴바 마우스클릭시 위치를 마음대로 이동할 수 있게끔 동작
	...
	public void backMain() {
		...
		Background = new ImageIcon(Main.class.getResource("../images/main_Background.jpg"))
				.getImage();
		backButton.setVisible(false);
		selectTrack(nowSelected);
		isGameScreen = false;
